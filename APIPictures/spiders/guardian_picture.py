...
class GuardianPictureSpider(CrawlSpider):
    ...
    rules = (
        Rule(LinkExtractor(restrict_xpaths="(//a[@class='fc-item__link'])[1]"), callback='parse_item', follow=True),
    )
    ...
    def parse_item(self, response):    
        ...
        for items_caption, picture_item in zip(caption_container, pictures_container):
            ...
            caption_text = items_caption.xpath("normalize-space(div[@class='gallery__caption']/text()[normalize-space()])").get()
